...
var _RadioButtonsInput = _interopRequireDefault(require("../components/RadioButtonsInput"));

var _DropdownInput = _interopRequireDefault(require("../components/DropdownInput"));
  ...
  _createClass(DefaultAndRadioButtonsForm, [{
    ...
    value: function render() {
      ...
      try {
        ...
        radioButtons = this.state.process && this.props.options && !error ? (0, _InputTypesFilter.filterRadioButtons)(this.state.process.task.parameters, this.props.options) : [];
        dropdown = this.state.process && this.props.options && !error ? (0, _InputTypesFilter.filterDropdowns)(this.state.process.task.parameters, this.props.options) : [];
        checkbox = this.state.process && this.props.options && !error ? (0, _InputTypesFilter.filterCheckBox)(this.state.process.task.parameters, this.props.options) : [];
      } catch (err) {
        error = err;
      }

      return _react["default"].createElement(_react["default"].Fragment, null, this.state.process && !error && _react["default"].createElement(_semanticUiReact.Container, null, _react["default"].createElement(_semanticUiReact.Form, null, defaultInputs.map(function (elem, idx) {
      ...
      }), radioButtons.map(function (elem, idx) {
        return _react["default"].createElement(_semanticUiReact.Form.Group, {
          widths: "equal",
          key: idx
        }, elem.map(function (param) {
          return _react["default"].createElement(_RadioButtonsInput["default"], {
            label: param.label,
            key: param.bpmParamName,
      ...
      }), dropdown.map(function (elem, idx) {
        return _react["default"].createElement(_semanticUiReact.Form.Group, {
          widths: "equal",
          key: idx
        }, elem.map(function (param) {
          return _react["default"].createElement(_DropdownInput["default"], {
            label: param.label,
      ...
      }), checkbox.map(function (elem, idx) {
        return _react["default"].createElement(_semanticUiReact.Form.Group, {
          widths: "equal",
          key: idx
        }, elem.map(function (param) {
      ...
      })), !this.props.creatInstance && _react["default"].createElement(_semanticUiReact.Button, {
        floated: "left",
        onClick: function onClick() {
          return _this2.handleSubmit(false);
        }
      }, "Back"), this.state.process.task.id && _react["default"].createElement(_semanticUiReact.Button, {
        floated: "left",
        onClick: this.handleCancel
      }, "Cancel"), this.state.process.task.id && _react["default"].createElement(_semanticUiReact.Button, {
        floated: "right",
        onClick: function onClick() {
